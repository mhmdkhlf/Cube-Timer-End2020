...
def _3x3():
    ...
    while len(scramble) < SCRAMBLE_LENGTH:
        ...
        if (len(scramble) > 0 and move.same_layer(scramble[-1])
         or len(scramble) > 1 and move.same_axis(*scramble[-2: ])):
            continue
        else:
            scramble.append(move)
    return scramble_turns(scramble)
...
def _4x4():
    ...
    while len(scramble) < SCRAMBLE_LENGTH:
        move = random_move(MOVES)
        if (len(scramble) > 0 and move.same_layer(scramble[-1])
         or len(scramble) > 1 and move.same_axis(*scramble[-2: ]) and move.same_layer(scramble[-2])
         or len(scramble) > 2 and move.same_axis(*scramble[-3: ])):
            continue
        else:
            scramble.append(move)
    return scramble_turns(scramble)
...
def _5x5():
    ...
    while len(scramble) < SCRAMBLE_LENGTH:
        ...
        if (len(scramble) > 0 and move.same_layer(scramble[-1])
         or len(scramble) > 1 and move.same_axis(*scramble[-2: ]) and move.same_layer(scramble[-2])
         or len(scramble) > 2 and move.same_axis(*scramble[-3: ]) and move.same_layer(scramble[-3])
         or len(scramble) > 3 and move.same_axis(*scramble[-4: ])):
            continue
        else:
            scramble.append(move)
    return scramble_turns(scramble)
